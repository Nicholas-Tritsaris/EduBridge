  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        Alert.alert('Signup Failed', response.data.message || 'Signup failed. Please try again.');
      }
    } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>Join the learning revolution</Text>
